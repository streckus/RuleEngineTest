//=========================================================================
//
//  This file was generated by Mouse 1.6 at 2014-07-16 17:39:00 GMT
//  from grammar
//    '/home/ivo/workspace/git.graphclasses.org/teo/isgci/appl/iq/iq.peg'.
//
//=========================================================================
...
public class IQParser extends mouse.runtime.ParserTest
{
  ...
  private boolean name()
    {
      ...
      if (!ahead('"',$Term15)) return reject(name);
  ...
  private boolean idstart()
    {
      ...
      if (nextIn('A','Z',$Term14)) return accept(idstart);
  ...
  private boolean idchar()
    {
      ...
      if (next('_',$Term19)) return accept(idchar);
  ...
  private boolean not()
    {
      ...
      if (!next("not",$Term3)) return reject(not);
  ...
  private boolean or()
    {
      ...
      if (!next("or",$Term9)) return reject(or);
  ...
  private boolean and()
    {
      ...
      if (!next("and",$Term2)) return reject(and);
  ...
  private boolean lparen()
    {
      ...
      if (!next('(',$Term17)) return reject(lparen);
      space();
  ...
  final Cache $Term2 = new Cache("\"and\"");
  final Cache $Term3 = new Cache("\"not\"");
