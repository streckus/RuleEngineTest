package teo.isgci.xml;
	...
	public class ISGCITempReader extends DefaultHandler{
	     ...
	     * by the reader.
	     */
	    public ISGCITempReader(DirectedGraph<GraphClass,Inclusion> g,
	    ...
	    private class GraphClassWrapper {
	        ...
	        public GraphClassWrapper(Integer id, String type, String dirtype) { //intID
	            ...
	            prevrefs = ISGCITempReader.this.refs;
	            ISGCITempReader.this.refs = refs = new ArrayList();
	        }

	        public void end() {
	            ISGCITempReader.this.refs = prevrefs;
	        }
